				...
				>
					...
					<div className="flex items-center gap-2 max-w-sm mx-auto">
						...
						<button
							type="button"
							onClick={copyLink}
							className="px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors duration-200"
						>
							Copy
						</button>
					</div>
					...
					<AnimatePresence mode="wait">
						{step === 1 ? (
							...
							>
								...
								<button
									type="submit"
									className="absolute right-0 top-0 bottom-0 bg-primary text-primary-foreground px-5 py-2 m-2 rounded-[12px] font-semibold hover:bg-primary/90 disabled:opacity-50 transition-colors duration-200"
									disabled={loading}
								>
									Continue
								</button>
							...
							>
								...
								<button
									type="submit"
									className="w-full bg-primary text-primary-foreground py-3 rounded-[12px] font-semibold hover:bg-primary/90 disabled:opacity-50 flex items-center justify-center transition-colors duration-200"
									disabled={loading}
								>
									{loading ? (
										<>
